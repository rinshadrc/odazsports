...
;(function($, window, document, undefined) {
	...
	DatePaginator.prototype = {
		...
		_init: function(options) {
			...
			if (this.options.startsFrom.length>0) {
				this.options.startsFrom = moment(this.options.startsFrom, this.options.selectedDateFormat).clone().startOf('day');
			}
		...
		_clickedHandler: function(event) {
			...
			var target = event.target.nodeName=="DIV"?$(event.target.parentElement):$(event.target);
		...
		_render: function() {
			...
			if (!this.initialized) {
				...
				this.$leftNav = $(this._template.navItem)
					...
					.append($(this._template.icon)
						.addClass('ri-arrow-left-double-fill')
						.addClass('dp-nav-left'))
				...
				this.$rightNav = $(this._template.navItem)
					...
					.addClass(this.options.squareEdges ? 'dp-nav-square-edges' : '')
					.append($(this._template.icon)
						.addClass('ri-arrow-right-double-fill')
						.addClass('dp-nav-right'))
					.width(this.options.navItemWidth);
			...
			$.each(data.items, function(id, item) {
				...
				frtxt=item.text.replace("<br/>","</div><div>");
				$a.append("<div>"+frtxt+"</div>");
		...
		_buildData: function() {
			...
			var viewWidth = (this.options.width - ((this.options.selectedItemWidth - this.options.itemWidth) + (this.options.navItemWidth * 2))),
				...
				start = this.options.startsFrom?this.options.startsFrom.clone():this.options.selectedDate.clone().subtract('days', unitsPerSide),
				end = this.options.startsFrom?this.options.startsFrom.clone().
add('days',units):this.options.selectedDate.clone().
add('days',units-unitsPerSide);console.log("start:"+start+"End:"+units);
			var data = {
		...
		_template: {
			list: '<ul class="pagination" style="display:flex"></ul>',
			listItem: '<li></li>',
			navItem: '<a href="#" class="dp-nav"></a>',
			dateItem: '<a href="#" class="dp-item"></a>',
			icon: '<i class="glyphicon"></i>',
			calendar: '<i id="dp-calendar" class="ri-calendar-line"></i>'
		},

		_css: '.datepaginator{font-size:12px;}.datepaginator-sm{font-size:10px;}.datepaginator-lg{font-size:14px;height:80px}.pagination{margin:0;padding:0;white-space:nowrap}.dp-nav{padding:1em 0!important;width:20px;margin:0!important;text-align:center;}.dp-nav-square-edges{border-radius:0!important}.dp-item{height:padding:3px 0!important;width:35px;margin:0!important;border-left-style:hidden!important;text-align:center;line-height:1.2!important;}.dp-item-sm{padding:5px!important}.dp-item-lg{height:80px!important;padding:9px 0!important}.dp-nav-sm{padding:11px 0!important}.dp-nav-lg{height:80px!important;padding:33px 0!important}a.dp-nav-right{border-left-style:hidden!important}.dp-divider{border-left:1px solid #ddd}.dp-off{background-color:#F0F0F0}.dp-no-select{color:#ccc!important;background-color:#F0F0F0!important}.dp-no-select:hover{background-color:#F0F0F0!important}.dp-today{background-color:#757BFF73!important;color:#fff!important}.dp-selected{background-color:#ab0909!important;color:#fff!important;width:140px}#dp-calendar{padding:3px 5px 0 0!important;margin-right:3px;position:absolute;right:0;top:10}'
	};
