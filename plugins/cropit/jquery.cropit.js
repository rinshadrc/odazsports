	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function init() {
	     ...
	     this.$errmsg.css("width",this.previewSize.w);
	     //alert(this.previewSize.w);
	      }
	    ...
	    value: function onImageLoaded() {
	    	this.$preview.removeClass('is-invalid');
	      this.imageSize = {
	        w: this.image.width,
	        h: this.image.height
	      };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var options = {
	  elements: [{
	    name: '$errmsg',
	    description: 'The HTML element that displays image error.',
	    defaultSelector: '.' + _constants.CLASS_NAMES.ERRMSG
	  },{
	    name: '$preview',
