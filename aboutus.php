            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                    <div class="tf-image-wrap">
                        <img class="w-100 ls-is-cached lazyloaded" data-src="images/collections/collection-69.jpg"
                    ...
                    <div class="tf-content-wrap px-0 d-flex justify-content-center w-100">
                        <div>
                            <div class="heading">We are Odas</div>
                            <div class="text">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                has been the industry's standard dummy text ever since the 1500s, when an unknown
                                printer took a galley of type and scrambled it to make a type specimen book. It has
                                survived not only five centuries, but also the leap into electronic typesetting,
                                remaining essentially unchanged. It was popularised inLorem Ipsum is simply dummy text
                                ...
                                popularised inLorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an
                                unknown printer took a galley of type and scrambled it to make a type specimen book. It
                                has survived not only five centuries, but also the leap into electronic typesetting,
                                remaining essentially unchanged. It was popularised in <br> <br> Lorem Ipsum is simply
                ...
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                    <div class="tf-content-wrap px-0 d-flex justify-content-center w-100">
                        <div>
                            ...
                            <div class="text">
                                Lorem Ipsum is simply dummy text of the printing and <br class="d-xl-block d-none">
                                Lorem Ipsum is simply dummy text of the printing and Lorem Ipsum is simply <br
                                    class="d-xl-block d-none">
                                Lorem Ipsum is simply dummy text of the printing and Lorem Ipsum is <br
                                    class="d-xl-block d-none">
                                Lorem Ipsum is simply dummy text of the printing and Lorem Ipsum is simply <br
                                    class="d-xl-block d-none">
                    ...
                    <div class="grid-img-group">
                        <div class="tf-image-wrap box-img item-1">
                            <div class="img-style">
                                <img class=" ls-is-cached lazyloaded" src="images/collections/collection-71.jpg"
                                    data-src="images/collections/collection-71.jpg" alt="img-slider">
                            </div>
                        </div>
                        <div class="tf-image-wrap box-img item-2">
                            <div class="img-style">
                                <img class=" ls-is-cached lazyloaded" src="images/collections/collection-70.jpg"
            ...
            <div class="container">
                <div class="bg_grey-2 radius-10 flat-wrap-iconbox">
                    <div class="flat-title lg">
                        ...
                        <div>
                            <p class="sub-title text_black-2"> Lorem Ipsum is simply dummy text of the printing and
                                Lorem Ipsum is simply Lorem Ipsum is simply dummy text of the </p>
                            <p class="sub-title text_black-2"> Lorem Ipsum is simply dummy text of the printing and
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-icon-box text-center">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="text_black-2">Lorem Ipsum is simply dummy text of the printing
        ...
        <section class="flat-testimonial-v2 flat-spacing-24">
            <div class="container">
                <div class="wrapper-thumbs-testimonial-v2 flat-thumbs-testimonial">
                    <div class="box-left">
                        <div dir="ltr"
                            class="swiper tf-sw-tes-2 swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden"
                            data-preview="1" data-space-lg="40" data-space-md="30">
                            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);"
                                id="swiper-wrapper-4d1448a3cea66914" aria-live="polite">
                                <div class="swiper-slide swiper-slide-active" style="width: 658px; margin-right: 40px;"
                                    role="group" aria-label="1 / 2">
                                    <div class="testimonial-item lg lg-2">
                                        <h4 class="mb_40">Our customer’s reviews</h4>
                                        <div class="icon">
                                            <img class=" ls-is-cached lazyloaded" data-src="images/item/quote.svg"
                                                alt="" src="images/item/quote.svg">
                                        </div>
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                            <i class="icon-star"></i>
                                ...
                                <div class="swiper-slide swiper-slide-next" style="width: 658px; margin-right: 40px;"
                        ...
                        <div class="d-md-flex d-none box-sw-navigation">
                            <div class="nav-sw nav-next-slider nav-next-tes-2 swiper-button-disabled" tabindex="-1"
                                role="button" aria-label="Previous slide"
                                aria-controls="swiper-wrapper-4d1448a3cea66914" aria-disabled="true"><span
                                    class="icon icon-arrow-left"></span></div>
                            <div class="nav-sw nav-prev-slider nav-prev-tes-2" tabindex="0" role="button"
                                aria-label="Next slide" aria-controls="swiper-wrapper-4d1448a3cea66914"
                                aria-disabled="false"><span class="icon icon-arrow-right"></span></div>
                        </div>
                        <div
                            class="d-md-none sw-dots style-2 sw-pagination-tes-2 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                    ...
                    <div class="box-right">
                        <div dir="ltr"
                            class="swiper tf-thumb-tes swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden"
                            data-preview="1" data-space="30">
                            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);"
                                id="swiper-wrapper-b7396d62e549e4cf" aria-live="polite">
                                <div class="swiper-slide swiper-slide-active" style="width: 718px; margin-right: 30px;"
                                    role="group" aria-label="1 / 2">
                                    <div class="img-sw-thumb">
                                        <img class="img-product ls-is-cached lazyloaded"
                                            data-src="images/item/tets3.jpg" src="images/item/tets3.jpg"
                                            alt="image-product">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-next" style="width: 718px; margin-right: 30px;"
                                    role="group" aria-label="2 / 2">
                                    <div class="img-sw-thumb">
                                        <img class="img-product ls-is-cached lazyloaded"
                                            data-src="images/item/tets4.jpg" src="images/item/tets4.jpg"
                                            alt="image-product">
                                    </div>
                                </div>
                            </div>
