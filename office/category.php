    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive">
                ...
                $itmcatobj->where("ct_status",0);
                $itmcategory = $itmcatobj->get("tbl_category", null, "ct_id,ct_title,ct_status");
                ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item openOffcanvas" href="#" data-toggle="offcanvas"  data-id="<?php echo $cat["ct_id"] ?>" data-name="<?php echo $cat["ct_title"] ?>"><i class="ri-pencil-line me-1"></i> Edit</a>
                                            <a class="dropdown-item openDelModal" href="#" data-title="Item category" data-type="category" data-delid="<?php echo $cat["ct_id"] ?>"><i class="ri-delete-bin-7-line me-1"></i> Delete</a>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="offcanvas-body mx-0 flex-grow-0 h-100">
                    <form class="add-new-user pt-0" id="frmItmCat">
                        ...
                        <div class="form-floating form-floating-outline mb-5">
                            <input type="text" class="form-control" id="txtCatname" name="txtCatname" placeholder="Category Title" />
                    ...
                    success: function(returnData) {
                        try {
                            ...
                            if (resparray.status == "done") {
                                alert = `<div class="alert alert-success" role="alert">Category Details added Successfully</div>`;
                            $("#errMsg").html(alert);
                                location.reload();
                            }
                        } catch (err) {}
