...
head("Movieclick Headoffice Module | Dashboard");
main_nav();
?>
...
<script src="<?php echo ROOT ?>plugins/apex-charts/apexcharts.js"></script>
<script src="<?php echo ROOT ?>plugins/apex-charts/apexcharts.js"></script>
  ...
  <div class="col-lg-3 col-sm-6">
    <div class="card h-100">
      <div class="row">
        ...
        <div class="col-6 text-end d-flex align-items-end">
          <div class="card-body pb-0 pt-7">
            <img src="../../assets/img/illustrations/card-session-illustration.png" alt="Ratings" class="img-fluid" width="81">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide pb-5">
          <div class="row">
            ...
            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
              <img src="../../assets/img/products/card-weekly-sales-controller.png" alt="weekly sales" width="230" class="weekly-sales-img">
            </div>
          </div>
        </div>
        <div class="swiper-slide pb-5">
          <div class="row">
            ...
            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
              <img src="../../assets/img/products/card-weekly-sales-watch.png" alt="weekly sales" width="230" class="weekly-sales-img">
            </div>
          </div>
        </div>
      </div>
        ...
        <ul class="nav nav-tabs nav-tabs-widget pb-6 gap-4 mx-1 d-flex flex-nowrap align-items-center" role="tablist">
          ...
          <li class="nav-item">
            <a href="javascript:void(0);" class="nav-link btn d-flex flex-column align-items-center justify-content-center" role="tab" data-bs-toggle="tab" data-bs-target="#navs-orders-id-2" aria-controls="navs-orders-id-2" aria-selected="false">
              <div>
                <img src="../../assets/img/products/apple-iMac-3k.png" alt="Apple iMac 3k" class="img-fluid">
              </div>
            </a>
          </li>
          <li class="nav-item">
            <a href="javascript:void(0);" class="nav-link btn d-flex flex-column align-items-center justify-content-center" role="tab" data-bs-toggle="tab" data-bs-target="#navs-orders-id-3" aria-controls="navs-orders-id-3" aria-selected="false">
              <div>
                <img src="../../assets/img/products/gaming-remote.png" alt="Gaming Remote" class="img-fluid">
              </div>
            </a>
          </li>
          <li class="nav-item">
          ...
          <div class="table-responsive text-nowrap">
            <table class="table border-top">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <img src="../../assets/img/products/samsung-s22.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                  <td>Samsung s22</td>
                  <td class="text-end">
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/apple-iPhone-13-pro.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                  <td>iPhone 14 Pro</td>
                  <td class="text-end">
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/oneplus-9-pro.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                  <td>Oneplus 9 Pro</td>
                  <td class="text-end">
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/google-pixel-6.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
          ...
          <div class="table-responsive text-nowrap">
            <table class="table border-top">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <img src="../../assets/img/products/apple-mac-mini.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/hp-envy-x360.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/dell-inspiron-3000.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/apple-iMac-4k.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                  <td>Apple iMac 4k</td>
                  <td class="text-end">
          ...
          <div class="table-responsive text-nowrap">
            <table class="table border-top">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <img src="../../assets/img/products/sony-play-station-5.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/xbox-series-x.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                  <td>XBOX Series X</td>
                  <td class="text-end">
                    <div class="badge bg-label-primary rounded-pill">Out of Stock</div>
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/nintendo-switch.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
                ...
                <tr>
                  <td>
                    <img src="../../assets/img/products/sup-game-box-400.png" alt="Mobile" width="34" height="34" class="rounded">
                  </td>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide card pb-5 shadow-none border-0">
          ...
          <div class="d-flex align-items-center mt-5">
            <img src="../../assets/img/products/card-marketing-expense-logo.png" alt="Marketing and sales" width="84" class="rounded-4">
        ...
        <div class="swiper-slide card pb-5 shadow-none border-0">
          ...
          <div class="d-flex align-items-center mt-5">
            <img src="../../assets/img/products/card-accounting-logo.png" alt="Marketing and sales" width="84" class="rounded-4">
            <div class="d-flex flex-column w-100 ms-6">
        ...
        <div class="swiper-slide card pb-5 shadow-none border-0">
          ...
          <div class="d-flex align-items-center mt-5">
            <img src="../../assets/img/products/card-sales-overview-logo.png" alt="Marketing and sales" width="84" class="rounded-4">
            <div class="d-flex flex-column w-100 ms-6">
