...
<head>
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="<?php echo ROOT ?>adminassets/css/perfect-scrollbar.css" />
    <link rel="stylesheet" href="<?php echo ROOT ?>adminassets/css/typeahead.css" />

    <!-- Page CSS -->
    <link rel="stylesheet" href="<?php echo ROOT ?>adminassets/css/page-auth.css">
...
<!-- / Content -->
    ...
    <script src="<?php echo ROOT ?>adminassets/js/perfect-scrollbar.js"></script>
  ...
  <script src="<?php echo ROOT ?>adminassets/js/pages-auth.js"></script>
