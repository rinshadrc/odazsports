!(function () {
    ...
    e && Sortable.create(e),
        ...
        a && Sortable.create(a, { animation: 150, group: { name: "cloneList", pull: "clone", revertClone: !0 } }),
        o && Sortable.create(o, { animation: 150, group: { name: "cloneList", pull: "clone", revertClone: !0 } }),
